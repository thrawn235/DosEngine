...
struct SoundBlasterInstrument
{
	char 	signature[4];
	char 	name[20];
	char 	modulatorSoundCharacteristic;
	char 	carrierSoundCharacteristic;
	char 	modulatorScalingLevel;
	char 	carrierScalingLevel;
	char 	modulatorAttackDelay;
	char 	carrierAttackDelay;
	char 	modulatorSustainRelease;
	char 	carrierSustainRelease;
	char 	modulatorWaveSelect;
	char 	carrierWaveSelect;
	char 	feedback;
	char 	reserved[4];
};
...
protected:
	...
	char channelMap[9] = {0x00, 0x01, 0x02, 0x08, 0x09, 0x0A, 0x10,  0x11,  0x12};
